...
if not Config.OxInventory and Config.EnableDefaultInventory then
    ESX.RegisterInput("showinv", TranslateCap("keymap_showinventory"), "keyboard", "TAB", function()
...
AddEventHandler("esx:copyToClipboard", function(dataType)
    ESX.Game.CopyToClipboard(dataType)
end)
