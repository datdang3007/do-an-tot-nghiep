...
ESX.RegisterCommand("vector2", "admin", function(xPlayer)
    xPlayer.triggerEvent("esx:copyToClipboard", "coords2")
end, false)

ESX.RegisterCommand("vector3", "admin", function(xPlayer)
    xPlayer.triggerEvent("esx:copyToClipboard", "coords3")
end, false)

ESX.RegisterCommand("vector4", "admin", function(xPlayer)
    xPlayer.triggerEvent("esx:copyToClipboard", "coords4")
end, false)

ESX.RegisterCommand("heading", "admin", function(xPlayer)
    xPlayer.triggerEvent("esx:copyToClipboard", "heading")
end, false)
